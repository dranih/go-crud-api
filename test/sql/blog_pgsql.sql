...
--
-- Name: abc_posts; Type: TABLE; Schema: public; Owner: postgres; Tablespace:
--
...
--
-- Name: abc_posts_category_id_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--
...
--
-- Name: abc_posts_user_id_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--
...
--
-- Name: abc_posts_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY abc_posts
    ADD CONSTRAINT posts_category_id_fkey FOREIGN KEY (abc_category_id) REFERENCES categories(id);


--
-- Name: abc_posts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
